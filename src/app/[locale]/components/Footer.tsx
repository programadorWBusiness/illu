    ...
    return (
        <footer className="w-screen h-full bg-redclear flex justify-center items-center md:h-[120px] flex-col" id="contact">
            <div className="w-[90%] h-full flex justify-between items-center flex-col mb-6 md:w-[70%] md:mb-0 md:flex-row">
                ...
                <div className="w-full h-full flex justify-between text-[13px] items-center text-white
                     font-bold mt-6 md:mt-0 md:w-[40%] lg:space-x-4 2xl:w-[30%]">
                    <a href="">POLITICA DE PRIVACIDAD</a>
                    <a href="">TÉRMINOS Y CONDICIONES</a>
                </div>
            </div>

            <a className='bg-browndark text-center w-screen flex justify-center items-center text-[14px] text-white'
